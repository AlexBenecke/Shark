...
#8-28-18#write_csv_fn( red.df, file = "data/raw-data/CPUE2.csv", row.names = FALSE, proj)
...
eff2 %>% select(tempbotm, startdepth, fluorobotm, turbbotm,
                oxybotm, salbotm, Dis.to.Shore ) %>% summary()
...
#8-28-18#write_csv_fn( eff2, file = "data/clean-data/CPUE3.csv", row.names = FALSE, proj)
```
